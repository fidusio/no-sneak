...
import io.xlogistx.nosneak.nmap.WellKnownPorts;
            ...
            if (allMode) {
                ...
                for (ProbeResult r : results) {
                    ...
                    if (r.getTlsState() != ProbeResult.TlsState.NONE) {
                        System.out.println("  " + io.xlogistx.nosneak.grade.Grade.of(r));
                    }
                ...
                if (result.getTlsState() != ProbeResult.TlsState.NONE) {
                    System.out.println("  " + io.xlogistx.nosneak.grade.Grade.of(result));
                }
