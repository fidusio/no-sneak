...
import io.xlogistx.nosneak.runtime.ScriptedTransport;
...
import static io.xlogistx.nosneak.ProbeCheckerTest.banner;
...
public class ProbePacingTest {
    ...
    private ProbeChecker.ContextFactory factory(ConnectionGate g) {
        ...
        return new ProbeChecker.ContextFactory() {
            @Override
            public io.xlogistx.nosneak.runtime.ProbeContext create(
            ...
            @Override
            public void start(io.xlogistx.nosneak.runtime.ProbeContext ctx) {
                registry.start(ctx);
            }

            @Override
            public void cancelled(io.xlogistx.nosneak.runtime.ProbeContext ctx) {
